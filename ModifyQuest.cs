...
namespace MH2DosQuestsReader
{
    public static class ModifyQuest
    {
        ...
        public static bool ReadQuset(byte[] src, out string _QuestName, out List<string> Infos)
        {
            ...
            //任务信息
            if (ModifyQuestMap(target, out List<string> out_ModifyQuestMap, out string QuestName))
            {
        ...
        public static bool ModifyQuestMap(byte[] src, out List<string> resultStr,out string QuestName)
        {
